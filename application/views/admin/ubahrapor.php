            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('admin/ubahrapor/') . $id . '/' . $nis; ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ahlak" id="ahlak" value="<?= $rapor['ekskul']; ?>" class="form-control">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('admin/tambahubahnilai/') . $id . '/' . $nis ?>" method="post">
                                <div class="form-group">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        foreach ($nilai as $n) { ?>
                            ...
                            <tr>
                                <td><?= $n['mapel']; ?></td>
                                <td><?= $n['angka']; ?></td>
                                <td><a href="<?= base_url('admin/hapusnilai/') . $id . '/' . $nis . '/' . $n['id_nilai']; ?>"> <button class=" btn btn-sm btn-danger">Hapus</button></a></>
                                </td>
                            </tr>
