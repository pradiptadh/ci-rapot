        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg">
                    ...
                    <a href="<?= base_url('walikelas/tambahrapor/'); ?>"><button class="btn btn-success mb-3 ">Tambah Rapor</button></a>
                        ...
                        <tbody>
                            ...
                            foreach ($datarapor as $r) { ?>
                                <tr>
                                    ...
                                    <td><?= $r['nama_kelas']; ?></td>
                                    <td>
                                        <a href="<?= base_url('walikelas/lihatrapor/') . $r['id_rapor'] . '/' . $r['nis']; ?>"><button class="btn btn-warning btn-sm">Lihat</button></a>

                                        <a href="<?= base_url('walikelas/ubahrapor/') . $r['nis']; ?>"><button class="btn btn-sm btn-primary ml-2 ">Ubah</button></a>

                                        <button class="btn btn-sm btn-danger ml-2 btnHapusRapor " href="<?= base_url('walikelas/hapusrapor/') . $r['nis'] . '/' . $r['id_rapor']; ?>">Hapus</button>
                                    </td>
                                </tr>
                            <?php
                            }
